...
<body>
    ...
    <ul>
        ...
        <li2><a class="active" href="cart.php">Cart</a></li2>
    </ul>
						...
						<div class="row2">
							<div class="col-50">
								<h3 style="text-align: center;">Checkout Form</h3>
									<div class="col-50">
										<div class="container">
											<h4>Cart Total <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> <b></b></span></h4>
												<p><a href="#">Subtotal</a> <span class="price">RM28.98</span></p>
												<p><a href="#">Shipping </a> <span class="price">RM4.50</span></p>
												<hr>
												<p style="color:black">Total<span class="price" style="color:black"><b>RM33.48</b></span></p>
										</div>
									</div>
									<br><br>
